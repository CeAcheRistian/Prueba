...
'''
String: para cadenas y caracteres de texto. Se usan comillas simples o dobles o triple comilla para cadenas con saltos de linea
Int: para numeros enteros positivos o negativos
...
#Con float() para tipos numéricos flotantes
